...
import { db } from './firebase'; // Assuming you exported Firestore instance from firebase.js
import './App.css';
...
export default function App() {
  ...
  // Create new task and save it to Firestore
  ...
  // Change status of a task and update Firestore
